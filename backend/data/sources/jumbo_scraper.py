...
HEADERS = {
    ...
    "apikey": os.getenv("JUMBO_API_KEY", ""),
...
def normalize_product(raw_product):
    ...
    # Prefer promos available to all users (paymentMethods="ALL") over member-only ones.
    ...
    for promo in promotions:
        ...
        # Prefer a non-exclusive lower promo; always take if no promo captured yet
